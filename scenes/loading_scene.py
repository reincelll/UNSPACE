...
class LoadingScene(Scene):
    def __init__(self, manager):
        ...
        rl.image_color_tint(self.game_icon, get_primary())
    ...
    def draw(self):
        ...
        rl.draw_texture_ex(self.raylib_logo, rl.Vector2(5, rl.get_screen_height() - (self.raylib_logo.height + 30)), 0, 1, get_primary())
